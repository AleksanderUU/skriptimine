#!/bin/bash
#Skript küsib ja vastab kasutajale mis aastaeg kuu on

#Küsib kasutajalt kuu numbrit
echo -e "Sisesta kuu number: "
read kuu

#Kontrollib kasutaja antud kuu numbit, mis aastaeg on ja kas number on kuu.
